...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      style={{
        position: 'fixed',
        // Soma a faixa do aparelho (barra inferior do iPhone, entalhe lateral
        // no modo deitado). Em telefone sem entalhe o env() vale zero e a
        // bolha fica exatamente onde sempre esteve.
