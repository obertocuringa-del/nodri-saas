...
export default function ListaTelefones() {
  ...
  function imprimir() {
    ...
    const css = `@page{size:A4 portrait;margin:12mm}*{box-sizing:border-box;margin:0;padding:0}body{font-family:'Segoe UI',Arial,sans-serif;color:#1a1a2e;font-size:11px}h1{text-align:center;font-size:15px;color:#5b4fcf;margin-bottom:8px}table{width:100%;border-collapse:collapse}th,td{border:1px solid #999;padding:5px 8px;text-align:left}th{background:#f1eefb;color:#3b2e7a}@media print{body{-webkit-print-color-adjust:exact;print-color-adjust:exact}}`
