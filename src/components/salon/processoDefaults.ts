  ...
  secoes: [
    {
      id: id(), titulo: 'CONTRATAÇÃO DE PROFISSIONAL PARCEIRO (PJ/MEI)', cor: '#16a34a', passos: [
        ...
        { id: id(), titulo: 'Etapa 13 — Dados Bancários', texto: 'Quando necessário:\n• Registrar os dados bancários do profissional para o pagamento.\n• O PJ abre a conta como empresa, pelo CNPJ dele — o salão não emite carta de abertura nesse caso.' },
