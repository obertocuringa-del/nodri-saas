...
export default function MateriaisTrabalho() {
  ...
  function imprimir() {
    ...
    const css = `@page{size:A4 landscape;margin:12mm}*{box-sizing:border-box;margin:0;padding:0}body{font-family:'Segoe UI',Arial,sans-serif;color:#1a1a2e}.hd{display:flex;justify-content:space-between;align-items:flex-end;border-bottom:3px solid #ec4899;padding-bottom:8px;margin-bottom:14px}.brand{font-size:22px;font-weight:900;color:#ec4899}h2{font-size:14px;color:#ec4899;margin:14px 0 6px;text-transform:uppercase;letter-spacing:.5px}table{width:100%;border-collapse:collapse;margin-bottom:6px;break-inside:avoid}th{background:#fdf2f8;color:#be185d;text-align:left;padding:7px 10px;border:none;border-bottom:2px solid #ec4899;font-size:10px;text-transform:uppercase;letter-spacing:.4px}td{padding:6px 10px;border:none;border-bottom:1px solid #eee}tbody tr:nth-child(even) td{background:#fbfaf8}@media print{body{-webkit-print-color-adjust:exact;print-color-adjust:exact}}`
