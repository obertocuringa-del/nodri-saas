...
export const CATALOGO: Record<string, Ferramenta> = {
  ...
  ck_tecnica:      { id: 'ck_tecnica', label: 'CHECK LIST — RESPONSÁVEL TÉCNICA', perm: 'checklist' },
  ck_profissionais:{ id: 'ck_profissionais', label: 'CHECK LIST — PROFISSIONAIS', perm: 'checklist' },
