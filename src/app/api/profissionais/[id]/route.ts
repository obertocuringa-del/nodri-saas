...
export async function PUT(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  const ALLOWED_COLS = new Set([
    ...
    'horarios_folgas','distrato','contrato_trabalho','tem_certificados','plano_carreira','data_demissao','cnpj_status','cnpj_observacao','vinculo','clt_observacao','avaliacoes','telefone',
